...
import { Center, AlertDialog, Button, Box, Divider, ScrollView, Text, VStack, HStack, Heading } from "native-base";
            ...
            <Center>
                ...
                >
                    <AlertDialog.Content>
                        ...
                        <AlertDialog.Body>
                            This action will delete all todo list data. 
                        ...
                        <AlertDialog.Footer>
                            <Button.Group space={2}>
                                ...
                                <Button colorScheme={"danger"} onPress={handleClearData}>Delete</Button>
                            </Button.Group>
                        </AlertDialog.Footer>
                    </AlertDialog.Content>
                </AlertDialog>
        ...
        <Box flex={1}>
            ...
            <ScrollView px={3} py={5}>
                <Box>
                    ...
                    <Text mt={3}>
                        This is a simple todo list applicatioon to use for learning
